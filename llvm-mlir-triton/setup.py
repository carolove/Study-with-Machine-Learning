...
def get_pybind11_package_info():
    ...
    # url = "https://github.com/pybind/pybind11/archive/refs/tags/v2.11.1.tar.gz"  # 注释掉不进行下载
    return Package("pybind11", name, "PYBIND11_INCLUDE_DIR", "", "PYBIND11_SYSPATH") # url, 
...
def get_llvm_package_info():
    ...
    # url = f"https://tritonlang.blob.core.windows.net/llvm-builds/{name}.tar.gz"  # 注释掉不进行下载
    return Package("llvm", name, "LLVM_INCLUDE_DIRS", "LLVM_LIBRARY_DIR", "LLVM_SYSPATH") #  url, 
